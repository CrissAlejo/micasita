...
const Ingresos = (prop) => {
  ...
  const [ingresos] = React.useState(prop.ingresos);
  const {metodo, dataNoCon} = prop;
  const ingConc = ingresos.filter( ing => metodo=='excel' ? ing.data().Conciliado === true : true )
  const ingNoConc = ingresos.filter( ing => ing.data().Conciliado === false)
    ...
    <view>
      {ingConc.length>0 && (
        ...
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography><b>{metodo=='excel' ? 'Ingresos conciliados' : 'Tabla de ingresos'}</b></Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      {ingNoConc.length > 0 && (
        ...
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography><b>Ingresos no conciliados</b></Typography>
        </AccordionSummary>
        <AccordionDetails>
        <TableContainer style={{width: "100%"}}>
        <Table className={classes.table} aria-label="customized table">
      ...
      {dataNoCon.length > 0 && (
        <Accordion defaultExpanded component={Paper}>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography><b>Ingresos del archivo excel que no fueron conciliados</b></Typography>
          </AccordionSummary>
          <AccordionDetails>
            <TableContainer style={{width: "100%"}}>
              <Table className={classes.table} aria-label="customized table">
